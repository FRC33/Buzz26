...
//Pratically a duplicate of BuzzTalonSRX 
public class BuzzTalonFX extends TalonFX {
    ...
    public double getMotorRPS() {
        return ((getSelectedSensorVelocity() / mTalonScalars.getCountsPerRev()) * 10d);
    }
    ...
    public void configPIDF(int slotIdx, double kP, double kI, double kD, double kF) {
